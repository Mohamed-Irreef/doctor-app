    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Animated.View style={[styles.iconWrapper, { transform: [{ scale }], opacity }]}>
          <View style={[styles.iconBg, { backgroundColor: isSuccess ? '#DCFCE7' : '#FEF2F2' }]}>
            {isSuccess
        ...
        {isSuccess && (
          <View style={styles.receiptCard}>
            ...
            <View style={styles.receiptRow}>
              ...
              <Text style={[Typography.body1, { fontWeight: '600' }]}>Oct 24, 2026</Text>
            </View>
            <View style={styles.receiptRow}>
              <Text style={Typography.body2}>Time</Text>
              <Text style={[Typography.body1, { fontWeight: '600' }]}>10:30 AM</Text>
            </View>
            <View style={[styles.receiptRow, { borderBottomWidth: 0 }]}>
              <Text style={Typography.body2}>Amount Paid</Text>
              <Text style={[Typography.h2, { color: Colors.success }]}>${amount ?? '150'}</Text>
            </View>
          </View>
        )}
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  scrollContent: { flexGrow: 1, alignItems: 'center', padding: 24, paddingTop: 60 },
  iconWrapper: { marginBottom: 32 },
  iconBg: { width: 140, height: 140, borderRadius: 70, alignItems: 'center', justifyContent: 'center' },
  headline: { textAlign: 'center', marginBottom: 16 },
  sub: { textAlign: 'center', color: Colors.textSecondary, lineHeight: 24, marginBottom: 40, paddingHorizontal: 16 },
  receiptCard: {
  ...
  bottomActions: { padding: 24, paddingBottom: 32, borderTopWidth: 1, borderTopColor: Colors.border, backgroundColor: Colors.surface },
});
